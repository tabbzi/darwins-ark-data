...
tables <- fa_table(fa.varimax)

var.comm = fa.varimax$communality
var.uniq = fa.varimax$uniqueness
var.total = var.comm + var.uniq


# Compute SS loadings
SS <-colSums(fa.varimax$Structure^2)
# Compute percentage of explained variance by factor
SS/length(fa.varimax$communality)
# Total explained variability
mean(fa.varimax$communality)
